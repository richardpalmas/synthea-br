...
import org.mitre.synthea.br.web.WebServerLauncher;
...
public class App {
  ...
  public static void usage() {
    ...
    System.out.println("         [--web]  Start local web UI for cohort generation");
    System.out.println("         [--config*=value]");
    System.out.println("          * any setting from src/main/resources/synthea.properties");
    System.out.println("");
    System.out.println("Note: When using both -c (config file) and --config*=value");
    System.out.println("(command-line), the last one specified wins. For example:");
  ...
  public static void main(String[] args) throws Exception {
      ...
      try {
        ...
        while (!argsQ.isEmpty()) {
          ...
          if (currArg.equalsIgnoreCase("-h") || currArg.equalsIgnoreCase("--help")) {
            usage();
            return;
          } else if (currArg.equalsIgnoreCase("--web")) {
            WebServerLauncher.startAndBlock();
            return;
    ...
    if (validArgs) {
      try {
        ...
        System.err.println("Failed to prepare output directory: " + e.getMessage());
        validArgs = false;
      }
    }

    if (validArgs && GenerationRunHelper.validateConfig(options, overrideFutureDateError)) {
